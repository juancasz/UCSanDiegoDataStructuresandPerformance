	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i=0;i<trials;i++) {
				BasicDocument testA = new BasicDocument(text);
				testA.getFleschScore();
			}
			long timeEnd = System.nanoTime();
			System.out.print((timeEnd-timeStart)/1000000+"\t");
			
			timeStart = System.nanoTime();
			for(int i=0;i<trials;i++) {
				EfficientDocument testB = new EfficientDocument(text);
				testB.getFleschScore();
			}
